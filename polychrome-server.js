		...
		jsdom.env({
			...
			scripts: ['http://code.jquery.com/jquery.js', '/javascripts/peer.js', '/javascripts/polychrome-accesspanel.js'],
				...
				$('link').each(function() {
					...
					if (css.indexOf(".co.uk") == -1 && css.indexOf(".com") == -1 ) {
				...
				$('image').each(function() {
					...
					if (image !== undefined && image.indexOf(".co.uk") == -1 && image.indexOf(".com") == -1) {
				...
				$('a').each(function() {
					...
					if (hyperlink !== undefined && hyperlink.indexOf(".co.uk") == -1 && hyperlink.indexOf(".com") == -1) {
