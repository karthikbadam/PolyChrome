...
d3.csv("/polychrome-datasets/iris.csv", function (flowers) {
    ...
    function plot(p) {
        ...
        cell.on("touchend", function () {
            ...
            if (event.isPolyChrome) {
                ...
                if (inUse) {
                    /* recycle event and send it to other peers */
                    PolyChromeEventHandler.wrapEvent("mouseup", event.touches[0].pageX, event.touches[0].pageY, event.target, event);
                    PolyChromeEventHandler.shareEvent();
                    inUse = false;
                }
                event.preventDefault();
